                                        ...
                                        <div class="col-lg-9">
                                            <div class="text-left">
                                                ...
                                                <p class="text-white font-size-24 mb-4">
                                                    Order anything from China and trust us for delivering your laggages.
                                                </p>

                                                <p class="text-white font-size-14">
                                                    At Company Name, we are committed to delivering our customers the highest level
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-4" x-data="initData()">
                                        ...
                                        <form class="form-horizontal" method="POST" @submit.prevent="submitForm" autocomplete="off">
                                            <section data-step="0">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="first_name" x-model="formData.first_name" placeholder="Write first name..." class="form-control" required />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="surname" x-model="formData.surname" placeholder="Write surname..." class="form-control" required />
                                                            <div class="invalid-feedback">
                                                                Surname required
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" name="email" x-model="formData.email" placeholder="Write email..." class="form-control" required />
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="phone" x-model="formData.phone" placeholder="Write phone..." class="form-control" required />
                                                            <div class="invalid-feedback">
                                                                Phone required
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="message" x-model="formData.description" placeholder="Write description ..." class="form-control" rows="3" required></textarea>
                                                            <div class="invalid-feedback">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="text-sm-end d-none d-sm-block">
                                                            ...
                                                            <button type="submit" name="submit" class="btn btn-primary" x-bind:disabled="formLoading" x-text="buttonText"></button>
                                                        </div>
                                                    </div>
                                                    <!--./col -->
                                                </div>
